...
static const u8 sRegisteredSelect_Gfx[] = INCBIN_U8("graphics/interface/select_button.4bpp"); //tx_registered_items_menu
        ...
        default:
            ...
            else if (JOY_NEW(START_BUTTON))
            {
                ...
                if (gBagPosition.pocket == TMHM_POCKET || gBagPosition.pocket == BERRIES_POCKET) {
                    static const u8 sText_CannotSort[] = _("Cannot sort this pocket!");
                    PlaySE(SE_FAILURE);
                    DisplayItemMessage(taskId, 1, sText_NothingToSort, HandleErrorMessage);
                    break;
                }
...
// Using __LINE__ as a neat trick to keep track of the order in the file, since we only care about
// comparison order
static const u16 sItemsSortOrder[ITEMS_COUNT] = {
    // Pokeballs
    // Gen I
    [ITEM_POKE_BALL] = __LINE__,
    [ITEM_GREAT_BALL] = __LINE__,
    [ITEM_ULTRA_BALL] = __LINE__,
    [ITEM_MASTER_BALL] = __LINE__,
    [ITEM_SAFARI_BALL] = __LINE__,
    // Gen II
    [ITEM_FAST_BALL] = __LINE__,
    [ITEM_LEVEL_BALL] = __LINE__,
    [ITEM_LURE_BALL] = __LINE__,
    [ITEM_HEAVY_BALL] = __LINE__,
    [ITEM_LOVE_BALL] = __LINE__,
    [ITEM_FRIEND_BALL] = __LINE__,
    [ITEM_MOON_BALL] = __LINE__,
    [ITEM_SPORT_BALL] = __LINE__,
    // Gen III
    [ITEM_NET_BALL] = __LINE__,
    [ITEM_DIVE_BALL] = __LINE__,
    [ITEM_NEST_BALL] = __LINE__,
    [ITEM_REPEAT_BALL] = __LINE__,
    [ITEM_TIMER_BALL] = __LINE__,
    [ITEM_LUXURY_BALL] = __LINE__,
    [ITEM_PREMIER_BALL] = __LINE__,
    // Gen IV
    [ITEM_DUSK_BALL] = __LINE__,
    [ITEM_HEAL_BALL] = __LINE__,
    [ITEM_QUICK_BALL] = __LINE__,
    [ITEM_CHERISH_BALL] = __LINE__,
    [ITEM_PARK_BALL] = __LINE__,
    // Gen V
    [ITEM_DREAM_BALL] = __LINE__,
    // Weird
    [ITEM_BEAST_BALL] = __LINE__,

    // Field Use
    [ITEM_REPEL] = __LINE__,
    [ITEM_SUPER_REPEL] = __LINE__,
    [ITEM_MAX_REPEL] = __LINE__,
    [ITEM_ESCAPE_ROPE] = __LINE__,
    [ITEM_HONEY] = __LINE__,

    // Health Restoration
    [ITEM_POTION] = __LINE__,
    [ITEM_SUPER_POTION] = __LINE__,
    [ITEM_HYPER_POTION] = __LINE__,
    [ITEM_MAX_POTION] = __LINE__,
    [ITEM_FULL_RESTORE] = __LINE__,
    [ITEM_REVIVE] = __LINE__,
    [ITEM_MAX_REVIVE] = __LINE__,
    [ITEM_SWEET_HEART] = __LINE__,
    [ITEM_BERRY_JUICE] = __LINE__,
    [ITEM_FRESH_WATER] = __LINE__,
    [ITEM_SODA_POP] = __LINE__,
    [ITEM_LEMONADE] = __LINE__,
    [ITEM_MOOMOO_MILK] = __LINE__,
    [ITEM_ENERGY_POWDER] = __LINE__,
    [ITEM_ENERGY_ROOT] = __LINE__,
    [ITEM_REVIVAL_HERB] = __LINE__,
    [ITEM_SACRED_ASH] = __LINE__,

    // Status Restoration
    [ITEM_ANTIDOTE] = __LINE__,
    [ITEM_BURN_HEAL] = __LINE__,
    [ITEM_ICE_HEAL] = __LINE__,
    [ITEM_AWAKENING] = __LINE__,
    [ITEM_PARALYZE_HEAL] = __LINE__,
    [ITEM_FULL_HEAL] = __LINE__,
    [ITEM_LAVA_COOKIE] = __LINE__,
    [ITEM_BIG_MALASADA] = __LINE__,
    [ITEM_OLD_GATEAU] = __LINE__,
    [ITEM_HEAL_POWDER] = __LINE__,

    // PP Restoration
    [ITEM_ETHER] = __LINE__,
    [ITEM_MAX_ETHER] = __LINE__,
    [ITEM_ELIXIR] = __LINE__,
    [ITEM_MAX_ELIXIR] = __LINE__,

    // EV Items
    [ITEM_HP_UP] = __LINE__,
    [ITEM_PROTEIN] = __LINE__,
    [ITEM_IRON] = __LINE__,
    [ITEM_CARBOS] = __LINE__,
    [ITEM_CALCIUM] = __LINE__,
    [ITEM_ZINC] = __LINE__,
    [ITEM_HEALTH_FEATHER] = __LINE__,
    [ITEM_MUSCLE_FEATHER] = __LINE__,
    [ITEM_RESIST_FEATHER] = __LINE__,
    [ITEM_GENIUS_FEATHER] = __LINE__,
    [ITEM_CLEVER_FEATHER] = __LINE__,
    [ITEM_SWIFT_FEATHER] = __LINE__,
    [ITEM_PRETTY_FEATHER] = __LINE__,
    [ITEM_PP_UP] = __LINE__,
    [ITEM_PP_MAX] = __LINE__,
    [ITEM_ABILITY_CAPSULE] = __LINE__,
    [ITEM_ABILITY_PATCH] = __LINE__,
    [ITEM_RARE_CANDY] = __LINE__,

    // Evolution Stones
    [ITEM_SUN_STONE] = __LINE__,
    [ITEM_MOON_STONE] = __LINE__,
    [ITEM_FIRE_STONE] = __LINE__,
    [ITEM_THUNDER_STONE] = __LINE__,
    [ITEM_WATER_STONE] = __LINE__,
    [ITEM_LEAF_STONE] = __LINE__,
    [ITEM_DAWN_STONE] = __LINE__,
    [ITEM_DUSK_STONE] = __LINE__,
    [ITEM_SHINY_STONE] = __LINE__,
    [ITEM_ICE_STONE] = __LINE__,
    [ITEM_OVAL_STONE] = __LINE__,

    // Evolution Items
    [ITEM_PROTECTOR] = __LINE__,
    [ITEM_ELECTIRIZER] = __LINE__,
    [ITEM_MAGMARIZER] = __LINE__,
    [ITEM_DUBIOUS_DISC] = __LINE__,
    [ITEM_REAPER_CLOTH] = __LINE__,
    [ITEM_PRISM_SCALE] = __LINE__,
    [ITEM_WHIPPED_DREAM] = __LINE__,
    [ITEM_SACHET] = __LINE__,
    [ITEM_UPGRADE] = __LINE__,

    // Battle Items
    [ITEM_GUARD_SPEC] = __LINE__,
    [ITEM_DIRE_HIT] = __LINE__,
    [ITEM_X_ATTACK] = __LINE__,
    [ITEM_X_DEFENSE] = __LINE__,
    [ITEM_X_SPEED] = __LINE__,
    [ITEM_X_ACCURACY] = __LINE__,
    [ITEM_X_SP_DEF] = __LINE__,
    [ITEM_X_SP_ATK] = __LINE__,
    [ITEM_POKE_DOLL] = __LINE__,
    [ITEM_FLUFFY_TAIL] = __LINE__,

    // Non-Battle Held items
    [ITEM_EXP_SHARE] = __LINE__,
    [ITEM_SOOTHE_BELL] = __LINE__,
    [ITEM_AMULET_COIN] = __LINE__,
    [ITEM_CLEANSE_TAG] = __LINE__,
    [ITEM_SMOKE_BALL] = __LINE__,
    [ITEM_EVERSTONE] = __LINE__,

    // Training Held Items
    [ITEM_MACHO_BRACE] = __LINE__,
    [ITEM_POWER_BRACER] = __LINE__,
    [ITEM_POWER_BELT] = __LINE__,
    [ITEM_POWER_LENS] = __LINE__,
    [ITEM_POWER_BAND] = __LINE__,
    [ITEM_POWER_ANKLET] = __LINE__,
    [ITEM_POWER_WEIGHT] = __LINE__,
    [ITEM_TRAINING_BAND] = __LINE__,

    // Held Items
    [ITEM_BRIGHT_POWDER] = __LINE__,
    [ITEM_WHITE_HERB] = __LINE__,
    [ITEM_QUICK_CLAW] = __LINE__,
    [ITEM_MENTAL_HERB] = __LINE__,
    [ITEM_CHOICE_BAND] = __LINE__,
    [ITEM_KINGS_ROCK] = __LINE__,
    [ITEM_SILVER_POWDER] = __LINE__,
    [ITEM_FOCUS_BAND] = __LINE__,
    [ITEM_LUCKY_EGG] = __LINE__,
    [ITEM_SCOPE_LENS] = __LINE__,
    [ITEM_METAL_COAT] = __LINE__,
    [ITEM_SOFT_SAND] = __LINE__,
    [ITEM_HARD_STONE] = __LINE__,
    [ITEM_MIRACLE_SEED] = __LINE__,
    [ITEM_BLACK_GLASSES] = __LINE__,
    [ITEM_BLACK_BELT] = __LINE__,
    [ITEM_MAGNET] = __LINE__,
    [ITEM_MYSTIC_WATER] = __LINE__,
    [ITEM_SHARP_BEAK] = __LINE__,
    [ITEM_POISON_BARB] = __LINE__,
    [ITEM_NEVER_MELT_ICE] = __LINE__,
    [ITEM_SPELL_TAG] = __LINE__,
    [ITEM_TWISTED_SPOON] = __LINE__,
    [ITEM_CHARCOAL] = __LINE__,
    [ITEM_DRAGON_FANG] = __LINE__,
    [ITEM_SILK_SCARF] = __LINE__,
    [ITEM_LEFTOVERS] = __LINE__,
    [ITEM_DRAGON_SCALE] = __LINE__,
    [ITEM_RAZOR_CLAW] = __LINE__,
    [ITEM_RAZOR_FANG] = __LINE__,
    [ITEM_SHELL_BELL] = __LINE__,
    [ITEM_POWER_HERB] = __LINE__,
    [ITEM_CHOICE_SCARF] = __LINE__,
    [ITEM_CHOICE_SPECS] = __LINE__,
    [ITEM_FOCUS_SASH] = __LINE__,
    [ITEM_WIDE_LENS] = __LINE__,
    [ITEM_ZOOM_LENS] = __LINE__,
    [ITEM_METRONOME] = __LINE__,
    [ITEM_MUSCLE_BAND] = __LINE__,
    [ITEM_WISE_GLASSES] = __LINE__,
    [ITEM_EXPERT_BELT] = __LINE__,
    [ITEM_LIGHT_CLAY] = __LINE__,
    [ITEM_ICY_ROCK] = __LINE__,
    [ITEM_SMOOTH_ROCK] = __LINE__,
    [ITEM_HEAT_ROCK] = __LINE__,
    [ITEM_DAMP_ROCK] = __LINE__,
    [ITEM_DESTINY_KNOT] = __LINE__,
    [ITEM_GRIP_CLAW] = __LINE__,
    [ITEM_LIFE_ORB] = __LINE__,
    [ITEM_TOXIC_ORB] = __LINE__,
    [ITEM_FLAME_ORB] = __LINE__,
    [ITEM_STICKY_BARB] = __LINE__,
    [ITEM_BLACK_SLUDGE] = __LINE__,
    [ITEM_IRON_BALL] = __LINE__,
    [ITEM_LAGGING_TAIL] = __LINE__,
    [ITEM_SHED_SHELL] = __LINE__,
    [ITEM_BIG_ROOT] = __LINE__,
    [ITEM_EVIOLITE] = __LINE__,
    [ITEM_FLOAT_STONE] = __LINE__,
    [ITEM_ROCKY_HELMET] = __LINE__,
    [ITEM_AIR_BALLOON] = __LINE__,
    [ITEM_RED_CARD] = __LINE__,
    [ITEM_RING_TARGET] = __LINE__,
    [ITEM_BINDING_BAND] = __LINE__,
    [ITEM_EJECT_BUTTON] = __LINE__,
    [ITEM_ABSORB_BULB] = __LINE__,
    [ITEM_CELL_BATTERY] = __LINE__,
    [ITEM_LUMINOUS_MOSS] = __LINE__,
    [ITEM_SNOWBALL] = __LINE__,
    [ITEM_WEAKNESS_POLICY] = __LINE__,
    [ITEM_ASSAULT_VEST] = __LINE__,
    [ITEM_SAFETY_GOGGLES] = __LINE__,
    [ITEM_ADRENALINE_ORB] = __LINE__,
    [ITEM_TERRAIN_EXTENDER] = __LINE__,
    [ITEM_PROTECTIVE_PADS] = __LINE__,
    [ITEM_ELECTRIC_SEED] = __LINE__,
    [ITEM_PSYCHIC_SEED] = __LINE__,
    [ITEM_MISTY_SEED] = __LINE__,
    [ITEM_GRASSY_SEED] = __LINE__,
    [ITEM_THROAT_SPRAY] = __LINE__,
    [ITEM_EJECT_PACK] = __LINE__,
    [ITEM_HEAVY_DUTY_BOOTS] = __LINE__,
    [ITEM_BLUNDER_POLICY] = __LINE__,
    [ITEM_ROOM_SERVICE] = __LINE__,
    [ITEM_UTILITY_UMBRELLA] = __LINE__,
    [ITEM_RUSTED_SWORD] = __LINE__,
    [ITEM_RUSTED_SHIELD] = __LINE__,
    [ITEM_SOUL_DEW] = __LINE__,
    [ITEM_DEEP_SEA_TOOTH] = __LINE__,
    [ITEM_DEEP_SEA_SCALE] = __LINE__,
    [ITEM_LUCKY_PUNCH] = __LINE__,
    [ITEM_METAL_POWDER] = __LINE__,
    [ITEM_THICK_CLUB] = __LINE__,
    [ITEM_LEEK] = __LINE__,
    [ITEM_LIGHT_BALL] = __LINE__,
    [ITEM_QUICK_POWDER] = __LINE__,
    [ITEM_ADAMANT_ORB] = __LINE__,
    [ITEM_LUSTROUS_ORB] = __LINE__,
    [ITEM_GRISEOUS_ORB] = __LINE__,

    // Incense
    [ITEM_SEA_INCENSE] = __LINE__,
    [ITEM_LAX_INCENSE] = __LINE__,
    [ITEM_ODD_INCENSE] = __LINE__,
    [ITEM_ROCK_INCENSE] = __LINE__,
    [ITEM_FULL_INCENSE] = __LINE__,
    [ITEM_WAVE_INCENSE] = __LINE__,
    [ITEM_ROSE_INCENSE] = __LINE__,
    [ITEM_LUCK_INCENSE] = __LINE__,
    [ITEM_PURE_INCENSE] = __LINE__,

    // Mega Stones
    [ITEM_RED_ORB] = __LINE__,
    [ITEM_BLUE_ORB] = __LINE__,
    [ITEM_VENUSAURITE] = __LINE__,
    [ITEM_CHARIZARDITE_X] = __LINE__,
    [ITEM_CHARIZARDITE_Y] = __LINE__,
    [ITEM_BLASTOISINITE] = __LINE__,
    [ITEM_BEEDRILLITE] = __LINE__,
    [ITEM_PIDGEOTITE] = __LINE__,
    [ITEM_ALAKAZITE] = __LINE__,
    [ITEM_SLOWBRONITE] = __LINE__,
    [ITEM_GENGARITE] = __LINE__,
    [ITEM_KANGASKHANITE] = __LINE__,
    [ITEM_PINSIRITE] = __LINE__,
    [ITEM_GYARADOSITE] = __LINE__,
    [ITEM_AERODACTYLITE] = __LINE__,
    [ITEM_MEWTWONITE_X] = __LINE__,
    [ITEM_MEWTWONITE_Y] = __LINE__,
    [ITEM_AMPHAROSITE] = __LINE__,
    [ITEM_STEELIXITE] = __LINE__,
    [ITEM_SCIZORITE] = __LINE__,
    [ITEM_HERACRONITE] = __LINE__,
    [ITEM_HOUNDOOMINITE] = __LINE__,
    [ITEM_TYRANITARITE] = __LINE__,
    [ITEM_SCEPTILITE] = __LINE__,
    [ITEM_BLAZIKENITE] = __LINE__,
    [ITEM_SWAMPERTITE] = __LINE__,
    [ITEM_GARDEVOIRITE] = __LINE__,
    [ITEM_SABLENITE] = __LINE__,
    [ITEM_MAWILITE] = __LINE__,
    [ITEM_AGGRONITE] = __LINE__,
    [ITEM_MEDICHAMITE] = __LINE__,
    [ITEM_MANECTITE] = __LINE__,
    [ITEM_SHARPEDONITE] = __LINE__,
    [ITEM_CAMERUPTITE] = __LINE__,
    [ITEM_ALTARIANITE] = __LINE__,
    [ITEM_BANETTITE] = __LINE__,
    [ITEM_ABSOLITE] = __LINE__,
    [ITEM_GLALITITE] = __LINE__,
    [ITEM_SALAMENCITE] = __LINE__,
    [ITEM_METAGROSSITE] = __LINE__,
    [ITEM_LATIASITE] = __LINE__,
    [ITEM_LATIOSITE] = __LINE__,
    [ITEM_LOPUNNITE] = __LINE__,
    [ITEM_GARCHOMPITE] = __LINE__,
    [ITEM_LUCARIONITE] = __LINE__,
    [ITEM_ABOMASITE] = __LINE__,
    [ITEM_GALLADITE] = __LINE__,
    [ITEM_AUDINITE] = __LINE__,
    [ITEM_DIANCITE] = __LINE__,
    [ITEM_ULTRANECROZIUM_Z] = __LINE__,
    [ITEM_MILOTICITE] = __LINE__,
    [ITEM_FLYGONITE] = __LINE__,
    [ITEM_BUTTERFRENITE] = __LINE__,
    [ITEM_LAPRASITE] = __LINE__,
    [ITEM_MACHAMPITE] = __LINE__,
    [ITEM_KINGLERITE] = __LINE__,
    [ITEM_KINGDRANITE] = __LINE__,

    // Flutes
    [ITEM_BLUE_FLUTE] = __LINE__,
    [ITEM_YELLOW_FLUTE] = __LINE__,
    [ITEM_RED_FLUTE] = __LINE__,
    [ITEM_BLACK_FLUTE] = __LINE__,
    [ITEM_WHITE_FLUTE] = __LINE__,

    // Tokens
    [ITEM_HEART_SCALE] = __LINE__,
    [ITEM_ODD_KEYSTONE] = __LINE__,
    [ITEM_BOTTLE_CAP] = __LINE__,
    [ITEM_GOLD_BOTTLE_CAP] = __LINE__,
    [ITEM_RED_SHARD] = __LINE__,
    [ITEM_BLUE_SHARD] = __LINE__,
    [ITEM_YELLOW_SHARD] = __LINE__,
    [ITEM_GREEN_SHARD] = __LINE__,

    // Sellables
    [ITEM_SHOAL_SALT] = __LINE__,
    [ITEM_SHOAL_SHELL] = __LINE__,
    [ITEM_TINY_MUSHROOM] = __LINE__,
    [ITEM_BIG_MUSHROOM] = __LINE__,
    [ITEM_PEARL] = __LINE__,
    [ITEM_BIG_PEARL] = __LINE__,
    [ITEM_STARDUST] = __LINE__,
    [ITEM_STAR_PIECE] = __LINE__,
    [ITEM_NUGGET] = __LINE__,
    [ITEM_RARE_BONE] = __LINE__,
    [ITEM_PEARL_STRING] = __LINE__,
    [ITEM_BIG_NUGGET] = __LINE__,
    [ITEM_COMET_SHARD] = __LINE__,
    [ITEM_BALM_MUSHROOM] = __LINE__,
    [ITEM_RELIC_COPPER] = __LINE__,
    [ITEM_RELIC_SILVER] = __LINE__,
    [ITEM_RELIC_GOLD] = __LINE__,
    [ITEM_RELIC_VASE] = __LINE__,
    [ITEM_RELIC_BAND] = __LINE__,
    [ITEM_RELIC_STATUE] = __LINE__,

    // Fossils
    [ITEM_HELIX_FOSSIL] = __LINE__,
    [ITEM_DOME_FOSSIL] = __LINE__,
    [ITEM_OLD_AMBER] = __LINE__,
    [ITEM_ROOT_FOSSIL] = __LINE__,
    [ITEM_CLAW_FOSSIL] = __LINE__,
    [ITEM_SKULL_FOSSIL] = __LINE__,
    [ITEM_ARMOR_FOSSIL] = __LINE__,
    [ITEM_COVER_FOSSIL] = __LINE__,
    [ITEM_PLUME_FOSSIL] = __LINE__,
    [ITEM_JAW_FOSSIL] = __LINE__,
    [ITEM_SAIL_FOSSIL] = __LINE__,
    [ITEM_FOSSILIZED_BIRD] = __LINE__,
    [ITEM_FOSSILIZED_FISH] = __LINE__,
    [ITEM_FOSSILIZED_DRAKE] = __LINE__,
    [ITEM_FOSSILIZED_DINO] = __LINE__,

    // Mail
    [ITEM_ORANGE_MAIL] = __LINE__,
    [ITEM_HARBOR_MAIL] = __LINE__,
    [ITEM_GLITTER_MAIL] = __LINE__,
    [ITEM_MECH_MAIL] = __LINE__,
    [ITEM_WOOD_MAIL] = __LINE__,
    [ITEM_WAVE_MAIL] = __LINE__,
    [ITEM_BEAD_MAIL] = __LINE__,
    [ITEM_SHADOW_MAIL] = __LINE__,
    [ITEM_TROPIC_MAIL] = __LINE__,
    [ITEM_DREAM_MAIL] = __LINE__,
    [ITEM_FAB_MAIL] = __LINE__,
    [ITEM_RETRO_MAIL] = __LINE__,

    // Plates
    [ITEM_FIST_PLATE] = __LINE__,
    [ITEM_SKY_PLATE] = __LINE__,
    [ITEM_TOXIC_PLATE] = __LINE__,
    [ITEM_EARTH_PLATE] = __LINE__,
    [ITEM_STONE_PLATE] = __LINE__,
    [ITEM_INSECT_PLATE] = __LINE__,
    [ITEM_SPOOKY_PLATE] = __LINE__,
    [ITEM_IRON_PLATE] = __LINE__,
    [ITEM_FLAME_PLATE] = __LINE__,
    [ITEM_SPLASH_PLATE] = __LINE__,
    [ITEM_MEADOW_PLATE] = __LINE__,
    [ITEM_ZAP_PLATE] = __LINE__,
    [ITEM_MIND_PLATE] = __LINE__,
    [ITEM_ICICLE_PLATE] = __LINE__,
    [ITEM_DRACO_PLATE] = __LINE__,
    [ITEM_DREAD_PLATE] = __LINE__,
    [ITEM_PIXIE_PLATE] = __LINE__,

    // Memories
    [ITEM_FIGHTING_MEMORY] = __LINE__,
    [ITEM_FLYING_MEMORY] = __LINE__,
    [ITEM_POISON_MEMORY] = __LINE__,
    [ITEM_GROUND_MEMORY] = __LINE__,
    [ITEM_ROCK_MEMORY] = __LINE__,
    [ITEM_BUG_MEMORY] = __LINE__,
    [ITEM_GHOST_MEMORY] = __LINE__,
    [ITEM_STEEL_MEMORY] = __LINE__,
    [ITEM_FIRE_MEMORY] = __LINE__,
    [ITEM_WATER_MEMORY] = __LINE__,
    [ITEM_GRASS_MEMORY] = __LINE__,
    [ITEM_ELECTRIC_MEMORY] = __LINE__,
    [ITEM_PSYCHIC_MEMORY] = __LINE__,
    [ITEM_ICE_MEMORY] = __LINE__,
    [ITEM_DRAGON_MEMORY] = __LINE__,
    [ITEM_DARK_MEMORY] = __LINE__,
    [ITEM_FAIRY_MEMORY] = __LINE__,
    [ITEM_BURN_DRIVE] = __LINE__,
    [ITEM_DOUSE_DRIVE] = __LINE__,
    [ITEM_SHOCK_DRIVE] = __LINE__,
    [ITEM_CHILL_DRIVE] = __LINE__,

    // Gems
    [ITEM_NORMAL_GEM] = __LINE__,
    [ITEM_FIGHTING_GEM] = __LINE__,
    [ITEM_FLYING_GEM] = __LINE__,
    [ITEM_POISON_GEM] = __LINE__,
    [ITEM_GROUND_GEM] = __LINE__,
    [ITEM_ROCK_GEM] = __LINE__,
    [ITEM_BUG_GEM] = __LINE__,
    [ITEM_GHOST_GEM] = __LINE__,
    [ITEM_STEEL_GEM] = __LINE__,
    [ITEM_FIRE_GEM] = __LINE__,
    [ITEM_WATER_GEM] = __LINE__,
    [ITEM_GRASS_GEM] = __LINE__,
    [ITEM_ELECTRIC_GEM] = __LINE__,
    [ITEM_PSYCHIC_GEM] = __LINE__,
    [ITEM_ICE_GEM] = __LINE__,
    [ITEM_DRAGON_GEM] = __LINE__,
    [ITEM_DARK_GEM] = __LINE__,
    [ITEM_FAIRY_GEM] = __LINE__,

    // Z-Crystals
    [ITEM_NORMALIUM_Z] = __LINE__,
    [ITEM_FIGHTINIUM_Z] = __LINE__,
    [ITEM_FLYINIUM_Z] = __LINE__,
    [ITEM_POISONIUM_Z] = __LINE__,
    [ITEM_GROUNDIUM_Z] = __LINE__,
    [ITEM_ROCKIUM_Z] = __LINE__,
    [ITEM_BUGINIUM_Z] = __LINE__,
    [ITEM_GHOSTIUM_Z] = __LINE__,
    [ITEM_STEELIUM_Z] = __LINE__,
    [ITEM_FIRIUM_Z] = __LINE__,
    [ITEM_WATERIUM_Z] = __LINE__,
    [ITEM_GRASSIUM_Z] = __LINE__,
    [ITEM_ELECTRIUM_Z] = __LINE__,
    [ITEM_PSYCHIUM_Z] = __LINE__,
    [ITEM_ICIUM_Z] = __LINE__,
    [ITEM_DRAGONIUM_Z] = __LINE__,
    [ITEM_DARKINIUM_Z] = __LINE__,
    [ITEM_FAIRIUM_Z] = __LINE__,
    [ITEM_ALORAICHIUM_Z] = __LINE__,
    [ITEM_DECIDIUM_Z] = __LINE__,
    [ITEM_EEVIUM_Z] = __LINE__,
    [ITEM_INCINIUM_Z] = __LINE__,
    [ITEM_KOMMONIUM_Z] = __LINE__,
    [ITEM_LUNALIUM_Z] = __LINE__,
    [ITEM_LYCANIUM_Z] = __LINE__,
    [ITEM_MARSHADIUM_Z] = __LINE__,
    [ITEM_MEWNIUM_Z] = __LINE__,
    [ITEM_MIMIKIUM_Z] = __LINE__,
    [ITEM_PIKANIUM_Z] = __LINE__,
    [ITEM_PIKASHUNIUM_Z] = __LINE__,
    [ITEM_PRIMARIUM_Z] = __LINE__,
    [ITEM_SNORLIUM_Z] = __LINE__,
    [ITEM_SOLGANIUM_Z] = __LINE__,
    [ITEM_TAPUNIUM_Z] = __LINE__,

    // Nectars
    [ITEM_RED_NECTAR] = __LINE__,
    [ITEM_YELLOW_NECTAR] = __LINE__,
    [ITEM_PINK_NECTAR] = __LINE__,
    [ITEM_PURPLE_NECTAR] = __LINE__,
};
...
static void SortItemsInBag(u8 pocket, u8 type)
{
    ...
    case MEDICINE_POCKET:
        ...
        break;
    case BATTLE_POCKET:
        itemMem = gSaveBlock1Ptr->bagPocket_Battle;
        itemAmount = BAG_BATTLE_COUNT;
        break;
    case MEGA_STONES_POCKET:
...
// Just sorting by item id
static s8 CompareItemsByType(struct ItemSlot* itemSlot1, struct ItemSlot* itemSlot2)
{
    //Null items go last
    u16 type1 = (itemSlot1->itemId == ITEM_NONE) ? 0xFFFF : sItemsSortOrder[itemSlot1->itemId];
    u16 type2 = (itemSlot2->itemId == ITEM_NONE) ? 0xFFFF : sItemsSortOrder[itemSlot2->itemId];
